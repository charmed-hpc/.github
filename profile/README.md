...
<img src="../assets/images/charmed-hpc-logo.png" alt="HPC logo of white atom symbol on Ubuntu orange background" style="width: 10vw;" />
...
* Start a discussion in the High-Performance Computing category on the [Ubuntu Discourse](https://discourse.ubuntu.com/c/project/hpc/151).
...
See the [Charmed HPC project documentation site](https://ubuntu.com/hpc/docs/latest/) for general user guidance on how to build and use Charmed HPC. For documentation contributions, see the [`charmed-hpc-docs`](https://github.com/canonical/charmed-hpc-docs) repository's [CONTRIBUTING.md](https://github.com/canonical/charmed-hpc-docs/blob/main/CONTRIBUTING.md) guidelines.

## ❓ FAQ

### Where can I contribute to Charmed HPC?

The upstream development of Charmed HPC primarily occurs in [Canonical's GitHub organization](https://github.com/canonical). You can find individual upstream project repositories by either visiting the [Underlying Project and Dependencies](https://ubuntu.com/hpc/docs/latest/reference/underlying-projects-and-dependencies/) page in Charmed HPC's documentation, or by filtering the Canonical GitHub organization by the [`charmed-hpc` topic](https://github.com/search?q=topic%3Acharmed-hpc%20org%3Acanonical&type=repositories).

The Charmed HPC GitHub organization is used to host community-contributed projects that are in the process of being upstreamed into Charmed HPC.

You can also join the Newswire room in the [#hpc:ubuntu.com] Matrix space to receive periodic development updates and Ubuntu Discourse notifications.
...
Support is provided on a best-effort basis; we are all busy people! The General room in the [#hpc:ubuntu.com] Matrix space is the best place to go for live discussion. If your question is rather complicated, you would like to be able to reference the solution later, or you prefer asynchronous communication, we recommend posting your question to the "High-Performance Computing" category on the Ubuntu Discourse instead.

### Where should I go if I want to report an issue/bug?

Send a message to the General room on the [#hpc:ubuntu.com] Matrix space. The team can help you triage the issue and point you to the correct project to raise a bug report against. Please make sure to also review the reportingss section of the [CONTRIBUTING.md guide](../CONTRIBUTING.md).
